...
export const StatusLineStyled = styled.div<{ $assignmentStatus: AssignmentI['status'] }>(
  ({ $assignmentStatus }) => css`
    ${getStatusProperties($assignmentStatus).style}
    position: absolute;
    left: 0;
    top: 0;
    bottom: 0;
...
export const StatusStyled = styled.div<{ $assignmentStatus: AssignmentI['status'] }>(
  ({ $assignmentStatus }) => css`
    ${getStatusProperties($assignmentStatus).style}
