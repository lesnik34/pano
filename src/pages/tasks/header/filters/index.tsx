...
import { TASK_PARAMS, VIEWED_SELF } from '@constants/pages';
...
const Parameters: React.FC<ParametersI> = ({ isLoading }) => {
  ...
  const badgeContent = isUserSelected ? <FaRegUser className="w-[7px]" /> : tasksStoreParams.statuses.length;
